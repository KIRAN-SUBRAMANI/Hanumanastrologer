...
<?php
$name="JaiHanuman ";
$phone="+1 647-616-4899";
$linkphone="+1 647-616-4899";
$whatsapp="+1 647-616-4899";
$email="hanumanastrologer@gmail.com";
$address="379 Albion Rd, Etobicoke
ON M9W 2P4."
...
<a class="whats-app" href="https://api.whatsapp.com/send?phone=16476164899&amp;text=Hi, I contacted you through your website.." target="_blank">
...
background: linear-gradient(to right, #DC281E, #F00000); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */;    background: linear-gradient(to right, #76170a, #8f0c8a);
">
		  <div class="container">
			<div class="top_header_inner">
			  <div class="logo">
		<ul class="" style="float:right;color:white;font-weight:bolder;">
					    Follow us <br>
             <a href="https://www.facebook.com/">
                  <img src="images/youtube.png" style="width:30px;">
              </a>
             
                  <a href="https://www.instagram.com/">
                       <img src="images/linkedin.png" style="width:30px;">
                  </a>
                 
             <a href="https://www.youtube.com/"> <img src="images/instagram.png" style="width:30px;"></a>
             <a href="https://www.youtube.com/"> <img src="images/twitter.png" style="width:30px;"></a>
             <a href="https://www.youtube.com/"> <img src="images/facebook.png" style="width:30px;"></a>
            </ul>
...
background: linear-gradient(to top, #FF4B2B, #FF416C); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */;    background: linear-gradient(to top, #FF4B2B, #ff9800);">
	
	
	
		<ul class="" style="float:left;color:white;font-weight:bolder;">
					    Follow us 
             <a href="https://www.facebook.com/">
                  <img src="images/youtube.png" style="width:30px;">
              </a>
      ...
      <div class="container">
        ...
        <div class="top_header_inner">
		  ...
		  <a href="index.html"><img class="img-fluid hidden-xs" src="images/logo.png" alt="Shiva Ji Trusted Astrologer"style="width:100%"></a>
		  </div>
		  
        <marquee>  <strong style="color:white;"> We Provide Genuine Spells For Every Problems - Get Real Psychic Advice On Love/Relationship Marriage, Career/Finance, Family Matters, Legal & More  The ritual is 100% safe for you.
		 </marquee> </strong>
		 	  <img src="./images/phonecall.png" class="animated flash infinite" style="width:100%;">
	...
	<div class="top_header m_header_contact hidden-xs" style="background-color: #fd3c02;">
      <div class="container">
        <div class="top_header_inner">
          <div class="get_advise">
            <div class="get_advise_text"> <span class="animated flash infinite">Call Us : <?php echo $phone?></a> </span>  <a href="tel:<?php echo $linkphone?>" title="<?php echo $linkphone?>"> </div>
			 <div class="get_advise_text">  <a href="tel:<?php echo $linkphone?>" title="<?php echo $linkphone?>">CANADA</a> </div>
          </div>
        </div>
      </div>
    </div>
	...
	<div class="container hidden-xs">
	   <marquee>  <strong style="color:#850a0a;"> We are Provide Genuine Spells For Every Problems - Get Real Psychic Advice On Love/Relationship Marriage, Career/Finance, Family Matters, Legal & More  The ritual is 100% safe for you.
		 </marquee> </strong>
</div>
     <!-- Start Navigation -->
    <nav class="navbar navbar-default bootsnav navbar-sticky nav-back">
        <div class="container">            
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href=""><img src="./images/Hanuman logo2.png" class="logo animated  slow pulse" alt="image-logo"></a>
                <!--
                ...
                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
					...
					<li class="dropdown">
                        ...
                        <ul class="dropdown-menu" style=" ">
                            <li> <a href="./astrologer-in-Ontario.php">Astrologer In Ontario </a> </li>
						<li> <a href="./astrologer-in-Toronto.php">Astrologer In Toronto </a> </li>
						<li> <a href="./astrologer-in-Brampton.php">Astrologer In Brampton </a> </li>
						<li> <a href="./astrologer-in-Mississauga.php">Astrologer In Mississauga </a> </li>
						<li> <a href="./astrologer-in-Oakville.php">Astrologer In Oakville </a> </li>
						<li> <a href="./astrologer-in-Burlington.php">Astrologer In Burlington </a> </li>
						<li> <a href="./astrologer-in-Hamilton.php">Astrologer In Hamilton </a> </li>
